...
// title, category, priority, assigned user). The description is immutable
// after creation — it is NOT part of the update surface. A nil pointer
// means "not provided"; a non-nil pointer means "set to this value".
